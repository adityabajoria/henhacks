...
ken_schedule = [Course("ECON101", True, [Assignment("Equilibrium", Date(3,5,2024), 20, "Homework"), 
                ...
                Course("HIST102", True, [Assignment("Midterm Essay", Date(3,16,2024), 75, "Exam"),
                                         ...
                                         Point(300,200,100,50)),
                Course("UNIV101", False, [], [], GradeCategory(0.0, 0.0, 0.0, 0.0), Point(0,0,0,0)),
                Course("CISC108", False, [], [], GradeCategory(0.30, 0.40, 0.20, 0.10), Point(0,0,0,0)),
                Course("CHEM164", False, [Assignment("Fake assignment", Date(3,3,2024), 100, "Homework")], [], 
